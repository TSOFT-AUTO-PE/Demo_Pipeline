...
public class Hook extends Listener {
	...
	private static final String GECKO_DRIVER 	= "/src/main/resources/driver/geckodriver.exe";
	private static final String CHROME_KEY 		= "webdriver.chrome.driver";
	private static final String CHROME_DRIVER 	= "/src/main/resources/driver/86/chromedriver.exe";
	private static final String IE_KEY 			= "webdriver.ie.driver";
	private static final String IE_DRIVER 		= "/src/main/resources/driver/IEDriverServer.exe";
